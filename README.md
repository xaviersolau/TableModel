...
```bash
Install-Package SoloX.TableModel -version 1.0.0-alpha.5
Install-Package SoloX.TableModel.Server -version 1.0.0-alpha.5
```

**Install using the .Net CLI:**
```bash
dotnet add package SoloX.TableModel --version 1.0.0-alpha.5
dotnet add package SoloX.TableModel.Server --version 1.0.0-alpha.5
```

**Install editing your project file (csproj):**
```xml
<PackageReference Include="SoloX.TableModel" Version="1.0.0-alpha.5" />
<PackageReference Include="SoloX.TableModel.Server" Version="1.0.0-alpha.5" />
```
